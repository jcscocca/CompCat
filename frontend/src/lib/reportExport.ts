...
export async function buildReportPackageFiles(
  ...
  const files: ReportFiles = {
    "overview.csv": csv([...COMMON_HEADERS, "unique_counting_basis", "unique_source_record_count", "membership_counting_basis", "membership_count", "returned_record_count", "records_truncated"], [[...base, report.sections.overview.unique_counting_basis, report.sections.overview.unique_source_record_count, report.sections.overview.membership_counting_basis, report.sections.overview.membership_count, report.sections.overview.returned_record_count, report.sections.overview.records_truncated]]),
